    ...
    <div class="py-12 px-4 md:px-0">
        <div
                ...
                <div class="flex max-h-full flex-col overflow-auto p-5">
                    ...
                    <div class="no-scrollbar max-h-full space-y-2.5 overflow-auto">
                        ...
                        <div
                            ...
                            <div class="relative mr-3 h-11 w-full max-w-11 rounded-full">
                                <img src="{{ asset('user-01.png') }}" alt="profile"
                        ...
                        <div
                            ...
                            <div class="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                                <img src="{{ asset('user-02.png') }}" alt="profile"
                                    class="h-full w-full object-cover object-center" />
                                <span
                                    class="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-success"></span>
                            </div>
                        ...
                        <div
                            class="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                            <div class="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                                <img src="{{ asset('user-03.png') }}" alt="profile"
                                    class="h-full w-full object-cover object-center" />
                                <span
                                    class="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-success"></span>
                            </div>
            ...
            <div class="flex h-full flex-col border-l border-stroke dark:border-strokedark xl:w-3/4">
                <!-- ====== Chat Box Start -->
                <div
                    class="sticky flex items-center justify-between border-b border-stroke px-4 py-4 dark:border-strokedark">
                    <div class="flex items-center">
                        <div class="mr-4 h-13 overflow-hidden rounded-full">
                            <img src="{{ asset('user-01.png') }}" alt="avatar"
                                class="h-full w-full object-cover object-center" />
                        </div>
                        <div>
