        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="max-w-sm mx-auto p-5">
                    <div class="mb-5">
                        <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category
                            Title
                        </label>
                    ...
                    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Option</label>
                    ...
                    <div class="flex items-center justify-between flex-column flex-wrap mt-4">
                        <div>
                            ...
                            <a href="{{ route('categories.master') }}"
