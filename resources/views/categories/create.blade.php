                        ...
                        <div class="flex gap-10">
                            <div class="inline-flex items-center">
                                <label class="relative flex items-center p-3 rounded-full cursor-pointer"
                                    for="income">
                                    <input name="type" type="radio" value="{{ $types[0]->value }}" id="income"
                            ...
                            <div class="inline-flex items-center">
                                <label class="relative flex items-center p-3 rounded-full cursor-pointer"
                                    for="expense">
                                    <input name="type" type="radio" value="{{ $types[1]->value }}" id="expense"
                                        class="before:content[''] peer relative h-5 w-5 cursor-pointer 
                            ...
                            <div class="inline-flex items-center">
                                <label class="relative flex items-center p-3 rounded-full cursor-pointer"
                                    for="others">
                                    <input name="type" type="radio" value="{{ $types[2]->value }}" id="others"
                                        class="before:content[''] peer relative h-5 w-5 cursor-pointer 
