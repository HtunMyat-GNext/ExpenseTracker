                ...
                <form method="GET" action="{{ route('categories.index') }}" class="relative">
                    ...
                    <div class="relative">
                        <input type="text" id="table-search-users" name="search"
                            ...
                            w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 
                                    ...
                                    <div class="flex">
                                        ...
                                        <a href="{{ route('categories.edit', $category->id) }}"
                                            ...
                                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 512 512">
                                                <path fill="#74C0FC" d="M441 58.9L453.1 71c9.4 9.4 9.4 24.6 0 33.9L424 134.1 377.9 
