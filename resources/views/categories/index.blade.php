                    ...
                    <div class="ml-2 ">
                        <select id="category_filter"
                            ...
                            <option value="all" {{ request('filter') == 'all' ? 'selected' : '' }}>
                                {{ __('All Category') }}</option>
                            <option value="income" {{ request('filter') == 'income' ? 'selected' : '' }}>Income
                            </option>
                            <option value="expense" {{ request('filter') == 'expense' ? 'selected' : '' }}>Expense
                            </option>
                            <option value="others" {{ request('filter') == 'others' ? 'selected' : '' }}>Others
                            </option>
                        </select>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#category_filter').change(function() {
            ...
            // disableDate();
            window.location.href = '{{ route('categories.index') }}' + '?filter=' + filterValue;
        });
                                ...
                                <div class="flex">
                                    <a href="/categories/${category.id}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-4">
                                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="#74C0FC" d="M441 58.9L453.1 71c9.4 9.4 9.4 24.6 0 33.9L424 134.1 377.9 88 407 58.9c9.4-9.4 24.6-9.4 33.9
                                            ...
                                            25L175.8 222.2c-8.7 8.7-15 19.4-18.3 31.1l-28.6 100c-2.4 8.4-.1 17.4 6.1 23.6s15.2 8.5 23.6 6.1l100-28.6c11.8-3.4 22.5-9.7
                                            31.1-18.3L487 138.9c28.1-28.1 28.1-73.7 0-101.8L474.9 25C446.8-3.1 401.2-3.1 373.1 25zM88 64C39.4 64 0 103.4 0 152V424c0
                                            48.6 39.4 88 88 88H360c48.6 0 88-39.4 88-88V312c0-13.3-10.7-24-24-24s-24 10.7-24 24V424c0 22.1-17.9 40-40 40H88c-22.1 0-40-17.9-40-40V152c0-22.1
                                            17.9-40 40-40H200c13.3 0 24-10.7 24-24s-10.7-24-24-24H88z"/>
                                        </svg>
                                    </a>
                                    <a href="#" x-data="" x-on:click.prevent="$dispatch('open-modal', { name: 'confirm-category-deletion',
                                    id: ${category.id} })" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path fill="#ce3b6f" d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3
