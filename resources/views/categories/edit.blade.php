                    ...
                    <div class="mb-5">
                     ...
                     <div class="color_picker grid grid-cols-2 gap-1">
                        <label for="hs-color-input" class="block text-sm font-medium mb-3 mt-2 dark:text-white">Choose Your Color</label>
                            <input type="color" class="p-1 h-10 w-full block bg-white border border-gray-300 cursor-pointer rounded-lg 
                            disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-100 dark:border-neutral-100" id="hs-color-input" 
                            value="{{$category->color}}" title="Choose your color" name="color">
                    </div>
                        ...
                        <div class="inline-flex items-center">
                            <label class="relative flex items-center p-3 rounded-full cursor-pointer" htmlFor="green">
                                <input name="is_income" type="radio" checked value="1"
                                    ...
                                    id="income" {{ $category->is_income == 1 ? 'checked' : '' }}/>

                                <span class="absolute text-green-500 transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 
                        ...
                        <div class="inline-flex items-center">
                            <label class="relative flex items-center p-3 rounded-full cursor-pointer" htmlFor="green">
                                <input name="is_income" type="radio" value="0"
                                    ...
                                    before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full 
                                    before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-green-500 checked:before:bg-green-500 
                                    hover:before:opacity-10" id="expense" {{ $category->is_income == 0 ? 'checked' : '' }}  />
