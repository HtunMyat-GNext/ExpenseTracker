                ...
                <div class="grid grid-cols-5 gap-4">
                    <div id='external-events' class="col-span-1">
                        ...
                        <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event m-2'>
                            <div class='fc-event-main p-2 text-center p-2 text-center'>Meeting with Team</div>
                        </div>
                        <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event m-2'>
                            <div class='fc-event-main p-2 text-center'>App Release</div>
                        </div>
                        <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event m-2'>
                            <div class='fc-event-main p-2 text-center'>To do Task</div>
                        </div>
                        <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event m-2'>
                            <div class='fc-event-main p-2 text-center'>Client Meeting</div>
                        </div>
                        <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event m-2'>
                            <div class='fc-event-main p-2 text-center'>My Birthday</div>
                        </div>
                    </div>
