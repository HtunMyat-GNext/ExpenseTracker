    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center justify-between flex-column flex-wrap md:flex-row mb-3">
                ...
                <input type="text" name="" id="search" placeholder="Search for Event"
...
<script>
    ...
    //                         <td class="px-6 py-4">
    //                             <div class="flex">
    //                                 <a href="/categories/${category.id}/edit" class="ffont-medium text-blue-600 dark:text-blue-500 hover:underline mr-4">
