    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="max-w-sm mx-auto p-5" method="POST" action="{{ route('events.update', $event) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="color_picker grid grid-cols-2 gap-1">
                        ...
                        <input type="color"
                            ...
                            id="hs-color-input" value="{{ old('color', $event->color) }}" title="Choose your color"
                            name="color">
                    </div>
                    {{-- Create Or Back Btn --}}
